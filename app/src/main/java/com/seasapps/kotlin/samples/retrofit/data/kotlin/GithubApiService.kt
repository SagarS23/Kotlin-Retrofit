...
interface GithubApiService {
    ...
    companion object Factory {
        fun create(): com.seasapps.kotlin.samples.retrofit.data.kotlin.GithubApiService {
            ...
            return retrofit.create(com.seasapps.kotlin.samples.retrofit.data.kotlin.GithubApiService::class.java);
        }
    }
}